...
class Register:
    def __init__(self,root):
        ...
        #================ Background Image ======================
        self.img=Image.open(r"college_images\nature.jpg")
        self.img=self.img.resize((1530,900), Image.ANTIALIAS)
        self.photoimg=ImageTk.PhotoImage(self.img)
 
        bg_lbl=Label(self.root,image=self.photoimg)
        bg_lbl.place(x=0,y=0,width=1530,height=900)


        #================ Background Image ======================
        self.img2=Image.open(r"college_images\quote.jpg")
        self.img2=self.img2.resize((470,550), Image.ANTIALIAS)
        ...
        #================= Row 3 =========================
        security_Q=Label(frame, text="Select Security Quetion", font=("times new roman", 15, "bold"), bg="white", fg="black")
        ...
        #============= Buttons ==================
        img=Image.open(r"college_images\loginpng.png")
        img=img.resize((200,50), Image. ANTIALIAS)
        self.photoimage=ImageTk.PhotoImage(img)
        b=Button (frame,command=self.return_login,image=self.photoimage, borderwidth=0,cursor="hand2", font=("times new roman",15, "bold"))
        b.place(x=50, y=440, width=200)
        ...
        b1=Button (frame,command=self.register_data , image=self.photoimage1, borderwidth=0,cursor="hand2", font=("times new roman",15, "bold"))
        b1.place(x=440, y=430, width=200,height=60)
    ...
    def register_data(self):
        if self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_contact.get()=="" or self.var_email.get ()=="" or self.var_securityQ.get()=="Select Question" or self.var_SecurityA.get()=="" or self.var_pass.get()=="" or self.var_confpass.get()=="":
